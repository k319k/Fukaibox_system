    ...
    return (
        <div className="space-y-4 pb-20">
            {sections.map((section) => {
                const index = sections.findIndex(s => s.id === section.id); // original index logic needed derived from order? Array order should be correct.
